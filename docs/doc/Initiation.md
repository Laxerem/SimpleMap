...
Проанализировав данный сайт, точно можно сказать, что он совмещает в себе именно то, что хочется видеть на странице с интерактивной картой, а именно:

* **Своя карта**, которая не реализованная в каком нибудь `GoogleMap API`, сделанная в **минималистичном виде**, в цветовой палитре данного сайта, из-за чего она не выглядит как ***инородный элемент***, а является частью <ins>**единого**</ins>.
  
* **Таймлайн**, который напрямую влияет на состояние ***интерактивной карты*** (карта в конкретный момент времени). Например, в нашем проекте мы хотим реализовать **таймлайн**, при взаимодействии с которым, меняется положение корабля в экспедиции.
...
Данный сайт достаточно информативен, в нём присутствуют карты, пусть и статичные.  

Основным плюсом **данного сайта**, является, по моему мнению, именно **информативность**, карты и информацию из которых, мы, пожалуй, позаимствуем для нашего сайта:)
...
Сайт структурирован и предоставляет информацию в хронологической последовательности (от предыстории открытия антарктиды, до исследований)

### Общий Вывод

  Исходя из просмотренных сайтов на просторах интернета, к сожалению, в сети не так много действительно интересных ресурсов, посвященных открытию Антарктиды.  

  Практически ни один из них не предлагает интерактивности, которая могла бы увлечь пользователя, и крайне редко встречаются исторические карты, способные оживить повествование. Текст на большинстве ресурсов подается огромными, неструктурированными блоками, которые не только сложно воспринимать, но и не вызывают желания углубляться в материал.  

  Кроме того, дизайн и оформление зачастую оставляют желать лучшего, что делает процесс изучения информации менее приятным и удобным.
...
| **Михаил Воробьёв (4 курс)** | **Программирование** | **По выходным** |
| **Николай Колесников** | **UI-UX дизайн** | **С 9 до 18 пн пт.** <br> Но заранее договариваемся о встрече |
| **Александр Василевский** | **История** | **Четверг:** 1 пара, <br> **Вторник:** 1 пара |
